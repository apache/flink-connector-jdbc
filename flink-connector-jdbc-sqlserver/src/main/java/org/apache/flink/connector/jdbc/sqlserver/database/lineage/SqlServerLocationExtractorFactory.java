...
@Internal
public class SqlServerLocationExtractorFactory implements JdbcLocationExtractorFactory {

    @Override
    public JdbcLocationExtractor createExtractor() {
        return new SqlServerLocationExtractor();
    }
}
