...
/**
 * Test class for OceanBase database catalog factory without default database option.
 *
 * <p>This test verifies catalog creation when the default database option is not provided, ensuring
 * that {@link OceanBaseCatalog} is properly instantiated using only the base URL configuration.
 */
