...
/** The OceanBase MySql mode params for {@link JdbcDialectTest}. */
public class OceanBaseMysqlDialectTest extends JdbcDialectTest implements OceanBaseMysqlTestBase {

    public OceanBaseMysqlDialectTest() {
        ddlFormat =
                "CREATE TABLE T (f0 %s)"
                        + " WITH ("
                        + "  'connector'='jdbc',"
