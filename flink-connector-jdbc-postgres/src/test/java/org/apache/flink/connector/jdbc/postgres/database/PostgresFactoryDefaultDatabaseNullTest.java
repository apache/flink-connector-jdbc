...
/**
 * Test class for PostgreSQL database catalog factory without default database option.
 *
 * <p>This test verifies catalog creation when the default database option is not provided, ensuring
 * that {@link PostgresCatalog} is properly instantiated using only the base URL configuration.
 */
class PostgresFactoryDefaultDatabaseNullTest implements PostgresTestBase {
