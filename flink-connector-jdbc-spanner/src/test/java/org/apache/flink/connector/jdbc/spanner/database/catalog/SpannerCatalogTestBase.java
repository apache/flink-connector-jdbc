...
class SpannerCatalogTestBase implements JdbcITCaseBase, SpannerTestBase {
    ...
    protected static TableRow createTableAllTypes(String name) {
        return spannerTableRow(
                ...
                field("col_timestamp", dbType("TIMESTAMP"), DataTypes.TIMESTAMP_LTZ(9)));
    }
    ...
    static void beforeAll() throws SQLException {
        ...
        try (Connection conn = SpannerDatabase.getMetadata().getConnection()) {
            ...
            TABLE_ALL_TYPES.insertIntoTableValues(
                    conn,
                    "'a', true, B'abc', DATE'2025-01-01', JSON'{\"key\": \"value1\"}', 1, 3.14, 1.1, -1.1, 'foo', TIMESTAMP'2025-01-01 00:00:00.123456789Z'",
                    "'b', false, B'123', DATE'2025-12-31', JSON'{\"key\": \"value2\"}', -1, -3.14, -1.1, 1.1, 'foo', TIMESTAMP'2025-12-31 00:00:00.987654321Z'");
            TABLE_ARRAY_TYPES.insertIntoTableValues(
                    ...
                    "'a', [true, false], [B'abc', B'123'], [DATE'2025-01-01', DATE'2025-12-31'], "
                            ...
                            + "[TIMESTAMP'2025-01-01 00:00:00.123456789Z', TIMESTAMP'2025-12-31 00:00:00.987654321Z']");
