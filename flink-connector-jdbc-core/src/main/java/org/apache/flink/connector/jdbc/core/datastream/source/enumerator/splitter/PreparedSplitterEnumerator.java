...
public class PreparedSplitterEnumerator implements SplitterEnumerator {
    ...
    public List<String> lineageQueries() {
        return Collections.singletonList(sqlTemplate);
    }
    ...
    protected JdbcSourceSplit createSplit(Serializable[] paramArr) {
        return new JdbcSourceSplit(getNextId(), sqlTemplate, paramArr, new CheckpointedOffset());
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(sqlTemplate, that.sqlTemplate)
                && Objects.deepEquals(sqlParameters, that.sqlParameters);
    }

    @Override
    public int hashCode() {
        return Objects.hash(sqlTemplate, Arrays.deepHashCode(sqlParameters));
    }
}
