...
/**
 * Testcontainers implementation for GaussDB. Supported images: {@code opengauss/opengauss}, {@code
 * pgvector/pgvector} Exposed ports: 8000
 */
public class GaussDBContainer<SELF extends GaussDBContainer<SELF>>
    ...
    private static final DockerImageName DEFAULT_IMAGE_NAME =
            DockerImageName.parse("opengauss/opengauss").asCompatibleSubstituteFor("gaussdb");
