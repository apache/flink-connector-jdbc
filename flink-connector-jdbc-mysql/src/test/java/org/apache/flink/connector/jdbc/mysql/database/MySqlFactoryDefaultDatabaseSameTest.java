...
/**
 * Test class for MySQL database catalog factory with matching database configuration.
 *
 * <p>Verifies that {@link MySqlCatalog} is correctly instantiated when the default database option
 * ("test") matches the database specified in the base URL (jdbc:mysql://localhost:56336/test).
 */
public class MySqlFactoryDefaultDatabaseSameTest implements MySqlTestBase {
