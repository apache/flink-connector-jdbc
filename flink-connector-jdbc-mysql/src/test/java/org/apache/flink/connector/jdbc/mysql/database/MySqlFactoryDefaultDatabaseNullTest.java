...
/**
 * Test class for MySQL database catalog factory without default database option.
 *
 * <p>This test verifies catalog creation when the default database option is not provided, ensuring
 * that {@link MySqlCatalog} is properly instantiated using only the base URL configuration.
 */
public class MySqlFactoryDefaultDatabaseNullTest implements MySqlTestBase {
