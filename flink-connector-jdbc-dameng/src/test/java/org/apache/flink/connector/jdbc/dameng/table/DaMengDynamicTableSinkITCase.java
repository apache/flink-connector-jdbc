...
/** The Table Sink ITCase for {@link DaMengDialect}. */
class DaMengDynamicTableSinkITCase extends JdbcDynamicTableSinkITCase implements DaMengTestBase {
    ...
    protected TableRow createUpsertOutputTable() {
        return tableRow(
                ...
                field("ts", dbType("TIMESTAMP(3)"), DataTypes.TIMESTAMP()));
    }
