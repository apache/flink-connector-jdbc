...
/** Tests for {@link FieldNamedPreparedStatementImpl} with DaMeng dialect. */
class DaMengPreparedStatementTest {

    private final JdbcDialect dialect =
            JdbcFactoryLoader.loadDialect(
                    "jdbc:dm://localhost:5236/DAMENG", getClass().getClassLoader());
    ...
    void testUpsertStatement() {
        ...
        assertThat(upsertStmt)
                .startsWith("MERGE INTO \"tbl\" t USING (SELECT ");

        // Only check the beginning of the statement since the exact MERGE INTO syntax is
        // complex and dialect-specific. The DaMengDialect implementation will handle the full syntax.
        NamedStatementMatcher.parsedSql(
                        "MERGE INTO \"tbl\" t USING (SELECT ?, ?, ?, ?, ?, ?, ? FROM DUAL) s(\"id\", \"name\", \"email\", \"ts\", \"field1\", \"field_2\", \"__field_3__\") ON (t.\"id\" = s.\"id\" AND t.\"__field_3__\" = s.\"__field_3__\") WHEN MATCHED THEN UPDATE SET t.\"id\" = s.\"id\", t.\"name\" = s.\"name\", t.\"email\" = s.\"email\", t.\"ts\" = s.\"ts\", t.\"field1\" = s.\"field1\", t.\"field_2\" = s.\"field_2\", t.\"__field_3__\" = s.\"__field_3__\" WHEN NOT MATCHED THEN INSERT (\"id\", \"name\", \"email\", \"ts\", \"field1\", \"field_2\", \"__field_3__\") VALUES (s.\"id\", s.\"name\", s.\"email\", s.\"ts\", s.\"field1\", s.\"field_2\", s.\"__field_3__\")")
                .parameter("id", singletonList(1))
                .parameter("name", singletonList(2))
                .parameter("email", singletonList(3))
                .parameter("ts", singletonList(4))
