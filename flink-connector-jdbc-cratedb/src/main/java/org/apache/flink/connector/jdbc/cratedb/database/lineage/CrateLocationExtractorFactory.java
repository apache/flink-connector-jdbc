...
@Internal
public class CrateLocationExtractorFactory implements JdbcLocationExtractorFactory {

    @Override
    public CrateLocationExtractor createExtractor() {
        return new CrateLocationExtractor();
    }
}
