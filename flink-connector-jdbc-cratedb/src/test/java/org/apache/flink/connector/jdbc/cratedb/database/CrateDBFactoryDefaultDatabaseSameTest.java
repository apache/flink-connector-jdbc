...
/**
 * Test class for CrateDB database catalog factory with matching database configuration.
 *
 * <p>Verifies that {@link CrateDBCatalog} is correctly instantiated when the default database
 * option ("test") matches the database specified in the base URL
 * (jdbc:crate://localhost:49290/crate).
 */
public class CrateDBFactoryDefaultDatabaseSameTest implements CrateDBTestBase {
    ...
    void test() {
        ...
        options.put(
                JdbcCatalogFactoryOptions.DEFAULT_DATABASE.key(), CrateDBCatalog.DEFAULT_DATABASE);
