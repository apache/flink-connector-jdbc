...
package org.apache.flink.connector.jdbc.clickhouse.database.lineage;
...
@Internal
public class ClickHouseLocationExtractorFactory implements JdbcLocationExtractorFactory {

    @Override
    public JdbcExtractor createExtractor() {
        return new ClickHouseJdbcExtractor();
    }
}
