...
/** The Abstract Table Sink For ClickHouse. */
public abstract class ClickHouseJdbcTableSinkITCase extends AbstractTestBase
        implements DatabaseTest {

    protected final ClickHouseTableRow upsertOutputTable = createUpsertOutputTable();
    protected final ClickHouseTableRow appendOutputTable = createAppendOutputTable();
    protected final ClickHouseTableRow batchOutputTable = createBatchOutputTable();
    protected final ClickHouseTableRow realOutputTable = createRealOutputTable();
    protected final ClickHouseTableRow checkpointOutputTable = createCheckpointOutputTable();
    protected final ClickHouseTableRow userOutputTable = createUserOutputTable();
    ...
    protected ClickHouseTableRow createRealOutputTable() {
        return clickHouseTableRow(
                "REAL_TABLE", field("real_data", dbType("REAL"), DataTypes.FLOAT()));
    }

    protected ClickHouseTableRow createCheckpointOutputTable() {
        return clickHouseTableRow("checkpointTable", field("id", DataTypes.BIGINT().notNull()));
    }
