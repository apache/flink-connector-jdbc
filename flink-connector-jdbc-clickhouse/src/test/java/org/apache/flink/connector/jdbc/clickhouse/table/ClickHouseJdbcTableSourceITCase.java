...
/** The Abstract Table Source For ClickHouse. */
public abstract class ClickHouseJdbcTableSourceITCase implements DatabaseTest {
    @RegisterExtension
    ...
    private final ClickHouseTableRow inputTable = createInputTable();
    ...
    @ParameterizedTest
    @EnumSource(ClickHouseJdbcTableSourceITCase.Caching.class)
    void testLookupJoin(ClickHouseJdbcTableSourceITCase.Caching caching) {
    ...
    private void lookupTableTest(
            ClickHouseJdbcTableSourceITCase.Caching caching,
        ...
        if (caching == ClickHouseJdbcTableSourceITCase.Caching.ENABLE_CACHE) {
            cachingOptions =
                    Arrays.asList(
    ...
    @ParameterizedTest
    @EnumSource(ClickHouseJdbcTableSourceITCase.Caching.class)
    void testLookupJoinWithFilter(ClickHouseJdbcTableSourceITCase.Caching caching) {
        List<Row> expectedResultSetRows =
                Arrays.asList(
                        Row.of(
                                2L,
    ...
    @ParameterizedTest
    @EnumSource(ClickHouseJdbcTableSourceITCase.Caching.class)
    void testLookupJoinWithMultipleFilters(ClickHouseJdbcTableSourceITCase.Caching caching) {
    ...
    @ParameterizedTest
    @EnumSource(ClickHouseJdbcTableSourceITCase.Caching.class)
    void testLookupJoinWithLikeFilter(ClickHouseJdbcTableSourceITCase.Caching caching) {
    ...
    @ParameterizedTest
    @EnumSource(ClickHouseJdbcTableSourceITCase.Caching.class)
    void testLookupJoinWithORFilter(ClickHouseJdbcTableSourceITCase.Caching caching) {
