...
public class ClickHouseTableField {

    private final String name;
    private final ClickHouseTableField.DbType dbType;
    private final DataType dataType;
    private final boolean pkField;

    protected ClickHouseTableField(
            String name, DataType dataType, ClickHouseTableField.DbType dbType, boolean pkField) {
