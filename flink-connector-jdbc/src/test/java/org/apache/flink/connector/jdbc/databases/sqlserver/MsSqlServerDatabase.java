...
public class MsSqlServerDatabase extends DatabaseExtension {

    private static final MSSQLServerContainer<?> container =
            new MSSQLServerContainer<>(DockerImageVersions.MSSQL_SERVER)
                    .acceptLicense()
                    .withLogConsumer(
                            new Slf4jLogConsumer(
                                    LoggerFactory.getLogger(MsSqlServerDatabase.class)));
