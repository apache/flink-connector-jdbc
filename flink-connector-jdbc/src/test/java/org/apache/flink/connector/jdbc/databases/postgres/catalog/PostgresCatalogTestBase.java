...
class PostgresCatalogTestBase {
    ...
    private static final DatabaseMetadata getDatabase() {
        return PostgresDatabase.getMetadata();
    }

    protected static final String TEST_CATALOG_NAME = "mypg";
    protected static final String TEST_USERNAME = getDatabase().getUser();
    protected static final String TEST_PWD = getDatabase().getPassword();
    ...
    static void init() throws SQLException {
        ...
        String jdbcUrl = getDatabase().getUrl();
    ...
    //        // delete test database and schema
