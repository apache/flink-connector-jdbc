...
/** Postgres Metadata. */
public class MsSqlServerMetadata implements DatabaseMetadata {
    ...
    protected MsSqlServerMetadata(MSSQLServerContainer<?> container) {
        this(container, false);
    }

    protected MsSqlServerMetadata(MSSQLServerContainer<?> container, boolean hasXaEnabled) {
