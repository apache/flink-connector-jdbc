...
/** A MySql database with XA enable. * */
public class MySqlXaDatabase extends DatabaseExtension {

    private static final MySQLContainer<?> container =
            new MySqlXaContainer(DockerImageVersions.MYSQL)
                    .withLogConsumer(
                            new Slf4jLogConsumer(LoggerFactory.getLogger(MySqlXaDatabase.class)))
